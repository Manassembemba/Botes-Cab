-- Migration: 20260210220000_fix_with_dynamic_inserts.sql
-- Description: Fonction avec gestion dynamique des colonnes pour éviter les erreurs NOT NULL
...
-- Créer la fonction finale avec gestion des erreurs
...
BEGIN
    ...
    IF p_montant > 0 AND p_is_charge_entreprise THEN
        -- Utiliser une insertion avec gestion des colonnes pour éviter les erreurs NOT NULL
