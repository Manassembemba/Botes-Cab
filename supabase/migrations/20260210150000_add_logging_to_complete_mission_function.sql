-- Migration: 20260210150000_add_logging_to_complete_mission_function.sql
-- Description: Ajout de logs pour capturer les erreurs dans la fonction complete_mission_simple

-- Mise à jour de la fonction avec des logs pour le débogage
