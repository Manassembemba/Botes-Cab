-- Migration: 20260210140000_fix_complete_mission_function.sql
-- Description: Correction de la fonction complete_mission_simple pour enlever la référence à client_id

-- Mise à jour de la fonction pour enlever la référence à client_id qui n'existe peut-être pas
...
DECLARE
    ...
    v_chauffeur_id int;
BEGIN
    -- Récupérer les infos de la mission (sans client_id)
