-- Migration: 20260210250000_fix_complete_mission_function_corrected.sql
-- Description: Version corrigée de la fonction avec déclarations appropriées
...
-- Recréer la fonction avec déclarations correctes
...
BEGIN
    ...
    -- 3. Récupérer le kilométrage actuel du véhicule pour l'entrée dans le journal
    ...
    -- Enregistrer dans le journal de bord avec le kilométrage
    BEGIN
