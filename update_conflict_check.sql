-- Script pour mettre à jour la fonction de vérification de conflit
-- Exécuter ce script dans la base de données distante via Supabase Studio

-- Supprimer le trigger existant
DROP TRIGGER IF EXISTS trigger_check_mission_overlap ON public.tb_missions;

-- Mettre à jour la fonction pour inclure les réservations dans la vérification
...
DO $$
BEGIN
    RAISE NOTICE 'Fonction et trigger de vérification de conflit mis à jour avec succès!';
END $$;